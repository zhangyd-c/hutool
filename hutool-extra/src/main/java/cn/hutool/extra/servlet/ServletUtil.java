...
public class ServletUtil {
	...
	public static void addCookie(HttpServletResponse response, String name, String value, int maxAgeInSeconds, String path, String domain) {
		addCookie(response, name, value, maxAgeInSeconds, path, domain, false);
	}
	 ...
	 */
	public static void addCookie(HttpServletResponse response, String name, String value, int maxAgeInSeconds, String path, String domain, boolean httpOnly) {
